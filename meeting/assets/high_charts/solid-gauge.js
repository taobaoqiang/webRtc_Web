...
(function (g) {
    ...
    (function (f) {
        ...
        v(f.Renderer.prototype.symbols, "arc", function (a, h, d, c, f, b) {
            a = a(h, d, c, f, b);
            b.rounded && (c = ((b.r || c) - b.innerR) / 2, b = ["A", c, c, 0, 1, 1, a[12], a[13]], a.splice.apply(a, [a.length - 1, 0].concat(["A", c, c, 0, 1, 1, a[1], a[2]])), a.splice.apply(a,
                [11, 3].concat(b)));
            return a
        });
        t = {
            initDataClasses: function (a) {
                ...
                a.dataClasses.forEach(function (b, l) {
                    b = f.merge(b);
                    d.push(b);
                    b.color || ("category" === g.dataClassColor ? (l = h.options.colors, b.color = l[c++], c === l.length && (c = 0)) : b.color = f.color(g.minColor).tweenTo(f.color(g.maxColor), l / (a.dataClasses.length - 1)))
                })
            },
            ...
            drawPoints: function () {
                ...
                a.points.forEach(function (b) {
                    var e = b.graphic,
                        ...
                        r = g(u(b.options.radius,
                            c.radius, 100)) * d[2] / 200,
                    ...
                    b.startR =
                        r;
                    e ? (r = m.d, e.animate(f.extend({
                        fill: n
                    }, m)), r && (m.d = r)) : (b.graphic = e = t.arc(m).attr({
                        fill: n,
                        "sweep-flag": 0
                    }).add(a.group), a.chart.styledMode || ("square" !== c.linecap && e.attr({
